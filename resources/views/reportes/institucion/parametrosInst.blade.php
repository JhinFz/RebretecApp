...
@section('content')
    ...
    <form action="{{ route('genreport.institucion') }}" method="GET" target="_blank" class="p-4 border rounded shadow">
        @csrf
